...
//
// Every number here was measured off the supplied reference. Its six timeline
...
// the same maths.
//
// Heet's story is seven years, not six. Rather than extrapolate an extra stop —
// which lands above the frame and collides with the act title — the measured
// node and card sequences are RESAMPLED at seven evenly spaced parametric
// positions. Both endpoints keep their measured values, every stop still sits
// on the fitted circle, and the uneven spacing the reference has (the years
// crowd together as the arc flattens) is preserved rather than averaged away.
// The composition is the reference's; it simply carries one more stop.

export const YEARS = [
  {
    year: 2020,
    key: 'The start',
    lines: ['Healthcare IT', 'Full SDLC', 'AWS IAM'],
  },
  {
    year: 2021,
    key: 'Products',
    lines: ['React and Node', 'REST on Express', 'Salesforce'],
  },
  {
    year: 2022,
    key: 'Hardening',
    lines: ['OWASP and RBAC', 'OAuth 2.0', 'CloudWatch'],
  },
  {
    year: 2023,
    key: 'The turn',
    lines: ['Joined ContextQA', 'First chatbots', '45% fewer tickets'],
  },
  {
    year: 2024,
    key: 'Agents',
    lines: ['MCP and ReAct', '500 runs a day', 'NDCG 0.81'],
  },
  {
    year: 2025,
    key: 'In production',
    lines: ['BiznezzAI', 'CaseGenius AI', '99.7% blocked'],
  },
  {
    year: 2026,
    key: 'Now',
    lines: ['Vanikaar', 'Speak it, ship it', 'No specs, no prompts'],
  },
];
